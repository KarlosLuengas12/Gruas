...
<body>
    ...
    <img id="logo" src="img/unnamed.png" alt="Logo Gobierno de Puebla">
  ...
  <div class="container">
    ...
    <div class="container bg-danger bg-opacity-75 p-3">
        ...
        <form class="text-white" method="post" action="">
            ...
            <br>
            <div id="map"></div>
            <div id="distanceLabel">Distancia: <span id="distanceValue">--</span> km</div>
            <br>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        <label for="almacen" class="form-label text-white">Almacén</label>
